...
const uint8_t Font8x8[128][8] = {
  ...
  { 0x00, 0x00, 0x2F, 0x00, 0x00, 0x00, 0x00, 0x00 }, // 33 '!'
  ...
  { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF }, // 48 '0'
  //{ 0x3E, 0x51, 0x49, 0x45, 0x3E, 0x00, 0x00, 0x00 }, // 48 '0'
  { 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC }, // 49 '1'
  ...
  { 0x08, 0x36, 0x41, 0x41, 0x36, 0x00, 0x00, 0x00 }, // 123 '{'
  { 0x00, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, // 124 '|'
  { 0x00, 0x41, 0x41, 0x36, 0x08, 0x00, 0x00, 0x00 }, // 125 '}'
  { 0x10, 0x08, 0x04, 0x08, 0x10, 0x00, 0x00, 0x00 }, // 126 '~'
  { 0x7F, 0x7F, 0x7F, 0x7F, 0x7F, 0x7F, 0x7F, 0x7F },  // 127 DEL 
};

void drawChar8x8(uint16_t x, uint16_t y, char c, uint16_t color) {
...
void drawString8x8(uint16_t x, uint16_t y, const char *str, uint16_t color) {
    uint16_t cursor_x = x;
    while (*str) {
        drawChar8x8(cursor_x, y, *str, color);
        cursor_x += 8;
        str++;
    }
}